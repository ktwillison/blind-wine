...
var svg = d3.select("#aroma_wheel").append("svg")
  .attr("width", wheel_width)
  .attr("height", wheel_height)
  .append("g")
...
d3.json("https://pure-headland-39202.herokuapp.com/api/v1.0/data/wine_data/", function(remote_json) {
